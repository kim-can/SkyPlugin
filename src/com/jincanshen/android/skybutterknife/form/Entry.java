package com.jincanshen.android.skybutterknife.form;
...
public class Entry extends JPanel {
    ...
    public Entry(EntryList parent, Element element, ArrayList<String> ids,boolean mModulesHolder) {
        mElement = element;
        mParent = parent;
        mGeneratedIDs = ids;
        ...
        if (!mGeneratedIDs.contains(element.getFullID(mModulesHolder))) {
